  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        exact
  path='/'
  render={(props) => <FirstPage username={this.state.username} email={this.state.email} {...props} submitForm={submitForm} postFetch={postFetch}  onChangePdf={onChangePdf}/>}
/>

<Route 
        exact
        path={`/submited${this.state.username}/${this.state.email} `}
  render={(props) => <SecondPage username={this.state.username} email={this.state.email} {...props} submitForm={submitForm} postFetch={postFetch}  onChangePdf={onChangePdf}/>}
/>
